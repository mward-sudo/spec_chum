...
- **M5 peripherals (in progress)** — joystick modes (Kempston / Sinclair / Cursor), Kempston mouse, Multiface 1 smoke, DivMMC / Interface 1 / Beta Disk stubs on Bus48/Bus128, +3 FDC READ DATA command stream on ports `3FFD`/`2FFD`, AY stereo ACB/ABC UI. Still incomplete vs real hardware: ESXDOS boot, IF1 Microdrive protocol, TR-DOS ROM paging edge cases ([#138](https://github.com/mward-sudo/spec_chum/issues/138)–[#140](https://github.com/mward-sudo/spec_chum/issues/140)).
