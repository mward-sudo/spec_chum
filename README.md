...
- **Timex TC2048 / TS2068** — TC2048 Phase 1 + TS2068 smoke-boot (home/EX-ROM, horizontal MMU, AY on F5/F6) + Warajevo `.dck` dock + SCLD **alt file / hi-colour** ([#192](https://github.com/mward-sudo/spec_chum/issues/192)); **512×192** hi-res still deferred. ROM: `./scripts/fetch_roms.sh` → [docs/TIMEX.md](docs/TIMEX.md).
