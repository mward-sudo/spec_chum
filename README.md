...
- **+3DOS** — command/result path and synthetic Loader / `LOAD "DISK"` smokes ([docs](tests/fixtures/plus3/README.md)); copy-protected / weird DSK geometry and CP/M SYSTEM boot remain out of scope.
