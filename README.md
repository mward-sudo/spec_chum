...
- **M5 peripherals (in progress)** — joystick modes (Kempston / Sinclair / Cursor), Kempston mouse, Multiface 1 smoke, DivMMC SPI sector I/O + automap on Bus48/Bus128, Interface 1 / Beta Disk stubs, +3 FDC READ DATA command stream on ports `3FFD`/`2FFD`, AY stereo ACB/ABC/Mono UI. Still incomplete vs real hardware: full ESXDOS boot (needs EEPROM fixture), IF1 Microdrive protocol, TR-DOS ROM paging edge cases ([#138](https://github.com/mward-sudo/spec_chum/issues/138)–[#140](https://github.com/mward-sudo/spec_chum/issues/140)).
