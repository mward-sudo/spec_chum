...
## Corpus Check
- 167 files · ~213,643 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4100 nodes · 11313 edges · 176 communities (145 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 269 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3c46539d`
...
Cohesion: 0.06
Nodes (11): HostError, HostRegs, HostSession, peek_poke_and_inspect_json(), BTreeMap, Error, Into, JoystickMode (+3 more)
...
Cohesion: 0.19
Nodes (37): apply_sna48_sets_pc_ram_and_border(), attr_mark_code_ok(), attr_mark_ear_load_quotes_code_succeeds_at_speed_10(), attr_mark_experience_load_succeeds(), attr_mark_fixture_flash_loads_code_bytes(), attr_mark_load_path_dumps_trace_on_failure(), attr_mark_load_path_must_succeed(), boggit_header_flash_loads_when_present() (+29 more)
...
Cohesion: 0.09
Nodes (11): TimexDockError, Machine, Model, plus3_loader_dos_boot_runs_titled_marker(), plus3_loader_load_disk_runs_basic_marker(), plus3_loader_talks_to_fdc_on_data_disk(), reset_keeps_plus3_disk_inserted(), rom_plus3_only() (+3 more)
...
Cohesion: 0.14
Nodes (38): attach_beta_on_48k_and_reject_plus3(), border_toggle_resizes_framebuffer(), cursor_left_via_joystick_applies_caps_five(), dims(), joystick_kempston_mask_reaches_port(), kempston_arrow_left_does_not_pollute_matrix(), kempston_mouse_ports_after_synthetic_deltas(), load_dsk_rejects_non_plus3() (+30 more)
...
Cohesion: 0.15
Nodes (28): apply_trdos_find_boot_native_abi(), apply_trdos_run_native_abi(), beta_reads_synthetic_boot_basic_into_ram(), beta_trdos_rom_loop_reads_trd_sector_into_ram(), beta_write_track_via_synthetic_rom(), debug_trdos_line_new_handoff(), debug_trdos_run_pc_trace(), ensure_trdos_beta128_prog() (+20 more)
...
### Community 34 - "Option"
Cohesion: 0.09
Nodes (18): advance_frame_t(), FrameAudio, interface1_opcode_fetch_pages_shadow_rom(), mem_port_watch(), next_frame_n(), peek_opcode(), reg_snap(), Cell (+10 more)
...
### Community 41 - ".new"
Cohesion: 0.14
Nodes (17): apply_prefs_to_session(), continue_and_eject_require_machine(), health_and_inspect_after_rom_load(), mouse_requires_kempston_pref_then_accepts_input(), prefs_apply_after_rom_load(), prefs_patch_round_trip(), PrefsPatch, rom48() (+9 more)
...
Cohesion: 0.08
Nodes (42): apply_snapshot128_plus3_applies_1ffd(), apply_snapshot128_z80_pages_and_7ffd(), apply_z80_snapshot48_sets_pc_ram_and_border(), attr_mark_load_matrix_models_and_speeds(), attr_mark_type_load_128k_flash(), attr_mark_type_load_plus3_flash(), ay_frame_audio_nonzero_when_tone_programmed(), custom_loader_matrix_models_instant_and_ear() (+34 more)
...
Cohesion: 0.11
Nodes (13): format_break_reason(), last_error_records_failures(), LastBreakResponse, LastErrorRecord, MemoryMapResponse, MemoryRegion, PagingSnapshot, String (+5 more)
...
Cohesion: 0.12
Nodes (11): Cli, main(), parse_model(), Option, Result, String, load_128_or_plus3_rom(), ModelId (+3 more)
...
### Community 81 - "Result"
Cohesion: 0.15
Nodes (11): interface1_rom_load_skips_cleanly_when_missing(), Interface1Error, MachineBuildError, model_16k_limits_ram_to_16k(), multiface_in_pages_out_and_back_for_return(), Default, Result, Self (+3 more)
...
### Community 129 - "WindowTitleBinder"
Cohesion: 0.17
...
- **Why does `HostBridge` connect `HostBridge` to `Model`, `.init`, `View`, `WindowTitleBinder`, `LivingRoomNSView`, `agent_embed.rs`, `PrefModelSlug`, `String`, `MachineConfigEditorView`, `RomSetupSlot`, `NSEvent`, `.onLivingRoomDisplayTick`, `.body`, `SpectrumNSView`, `Bool`, `ContentView`, `.takeLastError`, `TapeAudioPlayer`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **Why does `Machine` connect `Machine` to `.add_t`, `Bus128`, `Option`, `Ula48`, `Bus48`, `machine/src/lib.rs`, `.new_48k`, `joystick.rs`, `Ay8912`, `Result`, `Kempston`, `.read`, `Debugger`, `.step_once`, `BusPlus3`, `KempstonMouse`?**
  _High betweenness centrality (0.194) - this node is a cross-community bridge._
- **Why does `HostSession` connect `HostSession` to `host_api/src/ffi.rs`, `agent_embed.rs`, `ModelId`, `AgentClient`, `.new`, `Option`, `.share_host`, `joystick.rs`, `.with_session_ref`, `HostAccess`, `ControlPlane`, `.set_window_capture`, `error.rs`, `session.rs`, `Debugger`, `EmulatorHost`?**
