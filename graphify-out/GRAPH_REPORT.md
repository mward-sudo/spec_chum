...
## Corpus Check
- 204 files · ~257,288 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4608 nodes · 12467 edges · 204 communities (162 shown, 33 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 453 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `53df441b`
...
### Community 25 - "WindowTitleBinder"
Cohesion: 0.17
...
Cohesion: 0.08
Nodes (33): advance_frame_t(), beta_reads_synthetic_boot_basic_into_ram(), beta_trdos_rom_loop_reads_trd_sector_into_ram(), beta_write_track_via_synthetic_rom(), BetaDiskError, custom_loader_tap(), DivMmcError, interface1_opcode_fetch_pages_shadow_rom() (+25 more)
...
Cohesion: 0.10
Nodes (24): apply_snapshot128_plus3_applies_1ffd(), apply_snapshot128_z80_pages_and_7ffd(), attr_mark_load_matrix_models_and_speeds(), attr_mark_type_load_128k_flash(), attr_mark_type_load_plus3_flash(), ay_frame_audio_nonzero_when_tone_programmed(), boggit_side1_matrix_when_present(), inspect_128k_paging() (+16 more)
...
### Community 79 - "Vec"
Cohesion: 0.22
Nodes (9): FrameAudio, minimal_rzx(), minimal_tzx_pulse_deck(), minimal_tzx_turbo_machine(), push_ay_frame_sample(), Vec, rzx_replay_applies_keyboard_and_kempston(), synthetic_z80_v1_for_machine() (+1 more)
...
Cohesion: 0.07
Nodes (12): TimexDockError, custom_loader_ok(), InsertDiskError, Machine, Model, plus3_loader_dos_boot_runs_titled_marker(), plus3_loader_load_disk_runs_basic_marker(), plus3_loader_talks_to_fdc_on_data_disk() (+4 more)
...
- **Why does `HostSession` connect `HostSession` to `host_api/src/ffi.rs`, `AgentClient`, `HostError`, `ControlPlane`, `arkanoid_ram_diff.rs`, `src/session.rs`, `.with_session_ref`, `.load_rom_bytes_with_overrides`, `.regs`, `arkanoid_realtime_gate.rs`, `ModelId`, `EmulatorHost`, `.capture_framebuffer`, `service.rs`, `joystick.rs`, `.recompose_input`, `arkanoid_paddle_probe.rs`, `agent_embed.rs`, `.share_host`?**
...
- **Why does `Machine` connect `Machine` to `Cpu`, `.step_once`, `Ula48`, `boggit_side1_matrix_when_present`, `machine/src/lib.rs`, `.new_48k`, `joystick.rs`, `Vec`, `Kempston`, `Bus48`, `Debugger`, `.cpu`, `BusPlus3`, `Ay8912`, `KempstonMouse`?**
