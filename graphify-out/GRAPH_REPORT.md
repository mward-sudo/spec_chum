...
## Corpus Check
- 204 files · ~252,560 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4553 nodes · 12299 edges · 205 communities (164 shown, 32 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 453 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `019687a1`
...
Cohesion: 0.08
Nodes (11): HostError, peek_poke_and_inspect_json(), PendingMediaTitle, rom_search_roots(), Error, Path, Result, String (+3 more)
...
Cohesion: 0.16
Nodes (5): load_128_or_plus3_rom(), BTreeMap, Self, UserMachineConfig, select_model_keeps_session_model_in_sync()
...
### Community 75 - "TapPlayer"
Cohesion: 0.15
Nodes (9): advances_to_next_block_after_pause(), experience_pause_is_shorter_than_rom(), push_pulse(), Option, Vec, set_experience_mid_block_keeps_pulse_position(), set_speed_does_not_rebuild_or_shorten_schedule(), set_speed_mid_block_keeps_pulse_position() (+1 more)
...
### Community 123 - "crt_phosphor_local"
Cohesion: 0.67
...
### Community 126 - "deathchase_probe.rs"
Cohesion: 0.44
...
- **Why does `HostSession` connect `HostSession` to `host_api/src/ffi.rs`, `AgentClient`, `HostError`, `ControlPlane`, `arkanoid_ram_diff.rs`, `src/session.rs`, `HostViewState`, `.with_session_ref`, `service.rs`, `.debug_step`, `.load_snapshot`, `.regs`, `arkanoid_realtime_gate.rs`, `ModelId`, `EmulatorHost`, `media_title_lookup.rs`, `FramebufferMeta`, `joystick.rs`, `.share_host`, `arkanoid_paddle_probe.rs`, `agent_embed.rs`?**
