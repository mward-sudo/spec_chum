...
## Corpus Check
- 167 files · ~217,674 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4130 nodes · 11451 edges · 174 communities (143 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 282 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2e2a6b2b`
...
- **Why does `HostBridge` connect `HostBridge` to `Model`, `.init`, `.onLivingRoomDisplayTick`, `LivingRoomNSView`, `agent_embed.rs`, `PrefModelSlug`, `MachineConfigEditorView`, `RomSetupSlot`, `NSEvent`, `JoystickMode`, `.body`, `SpectrumNSView`, `Bool`, `ContentView`, `.takeLastError`, `TapeAudioPlayer`?**
