...
## Corpus Check
- 183 files · ~219,696 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4236 nodes · 11507 edges · 187 communities (157 shown, 24 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 450 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5eaf12d`
...
## Communities (187 total, 24 thin omitted)
...
Cohesion: 0.12
Nodes (27): parse_sna128_regs_banks_pc(), parse_sna128_when_paged_is_bank5(), parse_z80_rejects_undersized_extended_header(), parse_z80_v1_compressed_regs_and_ram(), parse_z80_v1_uncompressed_regs_and_ram(), parse_z80_v2_128_banks_and_7ffd(), parse_z80_v2_pages_land_at_48k_addresses(), parse_z80_v3_hw8_is_plus2a() (+19 more)
...
Cohesion: 0.23
Nodes (15): FormatError, Display, Error, String, decode_z80_page(), decode_z80_v1(), load_z80_v2_pages_128(), load_z80_v2_pages_48() (+7 more)
...
Cohesion: 0.20
Nodes (6): BTreeMap, Formatter, Machine, Model, PathBuf, Result
...
### Community 187 - ".installTrackingArea"
Cohesion: 0.14
...
## Knowledge Gaps
- **152 isolated node(s):** `PackageDescription`, `Notification.Name`, `.isMenuTracking`, `.body`, `.hasBeta` (+147 more)
...
- **Why does `HostSession` connect `HostSession` to `.open_tape`, `FramebufferMeta`, `host_api/src/ffi.rs`, `.patch_prefs`, `agent_embed.rs`, `AgentClient`, `HostError`, `service.rs`, `.new`, `Vec`, `joystick.rs`, `ControlPlane`, `.load_rom_bytes_with_overrides`, `HostViewState`, `src/session.rs`, `ModelId`, `EmulatorHost`?**
  _High betweenness centrality (0.257) - this node is a cross-community bridge._
- **Why does `Machine` connect `Machine` to `.add_t`, `Bus128`, `.step_once`, `Ula48`, `Bus48`, `machine/src/lib.rs`, `.new_48k`, `joystick.rs`, `Kempston`, `custom_loader_matrix_models_instant_and_ear`, `interface1_opcode_fetch_pages_shadow_rom`, `Debugger`, `.cpu`, `BusPlus3`, `KempstonMouse`?**
