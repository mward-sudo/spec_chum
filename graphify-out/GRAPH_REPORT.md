...
## Corpus Check
- 205 files · ~248,067 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4518 nodes · 12219 edges · 201 communities (161 shown, 31 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 453 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `db795ecd`
...
- fuse.rs
- formats/src/lib.rs
- boggit_side1_matrix_when_present
- dck.rs
- Result
- FlatMem
- String
...
Cohesion: 0.03
Nodes (46): .statusFooterDeckControls, Float, JoystickMode, UInt32, String, HostBridge, .isCustomConfigActive, .joystickMode (+38 more)
...
Cohesion: 0.19
Nodes (43): attr_mark_code_ok(), attr_mark_ear_load_quotes_code_succeeds_at_speed_10(), attr_mark_experience_load_succeeds(), attr_mark_fixture_flash_loads_code_bytes(), attr_mark_load_path_dumps_trace_on_failure(), attr_mark_load_path_must_succeed(), boggit_header_flash_loads_when_present(), boggit_load_quotes_flash_loads_header_when_present() (+35 more)
...
Cohesion: 0.06
Nodes (19): TimexDockError, apply_trdos_find_boot_native_abi(), apply_trdos_run_native_abi(), custom_loader_ok(), InsertDiskError, Machine, Model, plus3_loader_dos_boot_runs_titled_marker() (+11 more)
...
Cohesion: 0.10
Nodes (48): apply_sna48_sets_pc_ram_and_border(), apply_z80_snapshot48_sets_pc_ram_and_border(), custom_loader_tap(), debug_trdos_line_new_handoff(), debug_trdos_run_pc_trace(), ensure_trdos_beta128_prog(), enter_128k_basic_from_menu(), enter_trdos_command_mode() (+40 more)
...
Cohesion: 0.07
Nodes (27): emit_contend_sampled(), interface1_opcode_fetch_pages_shadow_rom(), manual_read_track1_sector1(), mem_port_watch(), MemIo128, MemIo48, MemIoPlus3, peek_opcode() (+19 more)

### Community 35 - "LivingRoomNSView"
Cohesion: 0.10
Nodes (15): LivingRoomNSView, .acceptsFirstResponder, .canBecomeKeyView, .focusRingMaskBounds, .host, .isFlipped, Any, Bool (+7 more)
...
Cohesion: 0.09
Nodes (30): LastErrorResponse, Option, new_shared_host_view(), SharedHostView, apply_prefs_to_session(), capture_framebuffer_border_override_restores(), capture_framebuffer_restores_border_when_run_fails(), continue_and_eject_require_machine() (+22 more)
...
### Community 70 - "boggit_side1_matrix_when_present"
Cohesion: 0.10
Nodes (25): apply_snapshot128_plus3_applies_1ffd(), apply_snapshot128_z80_pages_and_7ffd(), attr_mark_load_matrix_models_and_speeds(), attr_mark_type_load_128k_flash(), attr_mark_type_load_plus3_flash(), ay_frame_audio_nonzero_when_tone_programmed(), boggit_side1_matrix_when_present(), inspect_128k_paging() (+17 more)
...
### Community 72 - "Result"
Cohesion: 0.17
Nodes (13): beta_reads_synthetic_boot_basic_into_ram(), beta_trdos_rom_loop_reads_trd_sector_into_ram(), beta_write_track_via_synthetic_rom(), BetaDiskError, DivMmcError, interface1_rom_load_skips_cleanly_when_missing(), Interface1Error, Result (+5 more)
...
### Community 98 - "Bus128"
Cohesion: 0.17
Nodes (4): Bus128, emit_floating_sampled(), out_7ffd_screen_switch_spills_into_next_frame(), Vec
...
### Community 120 - ".scheduleSteppedResizeIfNeeded"
Cohesion: 0.21
Nodes (4): Context, Int, DispatchWorkItem, NSView
...
### Community 123 - "RomLoadError"
Cohesion: 0.47
Nodes (3): RomLoadError, Error, Result
...
Cohesion: 0.21
Nodes (15): arkanoid_path(), hex_range(), load_tape(), main(), Machine, Path, PathBuf, String (+7 more)
...
### Community 183 - ".handleButton"
Cohesion: 0.12
Nodes (6): KempstonMouseTracking, Bool, Int, NSEvent, NSView, NSEvent
...
- **Why does `HostSession` connect `HostSession` to `host_api/src/ffi.rs`, `AgentClient`, `HostError`, `ControlPlane`, `arkanoid_ram_diff.rs`, `src/session.rs`, `.new`, `HostViewState`, `.with_session_ref`, `service.rs`, `arkanoid_pbrain_watch.rs`, `.select_model`, `.regs`, `ModelId`, `EmulatorHost`, `media_title_lookup.rs`, `.capture_framebuffer`, `joystick.rs`, `agent_embed.rs`?**
...
- **Why does `HostBridge` connect `HostBridge` to `Model`, `.init`, `LivingRoomNSView`, `PrefModelSlug`, `AppKit`, `RomSetupSlot`, `LoadKeyScript`, `MachineConfigEditorView`, `.body`, `SpectrumNSView`, `.refreshInspector`, `agent_embed.rs`, `.handleButton`, `.scheduleSteppedResizeIfNeeded`, `ContentView`, `TapeAudioPlayer`, `.onLivingRoomDisplayTick`?**
