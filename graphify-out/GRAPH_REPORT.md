...
## Corpus Check
- 232 files · ~264,510 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4726 nodes · 12527 edges · 223 communities (177 shown, 36 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 726 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `62f32997`
...
Cohesion: 0.07
Nodes (70): apply_snapshot128_plus3_applies_1ffd(), apply_snapshot128_z80_pages_and_7ffd(), apply_trdos_find_boot_native_abi(), apply_trdos_run_native_abi(), beta_reads_synthetic_boot_basic_into_ram(), beta_trdos_rom_loop_reads_trd_sector_into_ram(), beta_write_track_via_synthetic_rom(), BetaDiskError (+62 more)
...
Cohesion: 0.11
Nodes (16): peek_opcode(), plus2a_stack_repair_ignores_coincidental_0038_marker(), reg_snap(), rom_timex_ts2068(), FnMut, Option, TapeDeck, timex_ts2068_ay_advances_on_step_apis() (+8 more)
...
Cohesion: 0.10
Nodes (23): corrupt_file_falls_back_to_defaults(), custom_configs_round_trip(), default_prefs_path(), load_prefs(), load_prefs_unlocked(), missing_file_falls_back_to_defaults(), model_rom_paths_round_trip(), pref_model_slug() (+15 more)
...
Cohesion: 0.13
Nodes (15): button_pages_on_nmi_vector(), in_9f_pages_in_in_1f_pages_out(), load_rom_size_check(), mf128_in_bf_returns_screen_bit_and_in_3f_pages_out(), mf128_out_while_paged_sets_software_enable(), mf128_power_up_stealth_blocks_page_in_until_nmi(), mf128_reset_clears_enable_keeps_ram(), Multiface128 (+7 more)
...
Cohesion: 0.19
Nodes (24): canonical_persist_path(), install_model_rom(), model_requires_user_rom(), model_rom_available(), model_rom_paths_snapshot(), pentagon_rom_setup_has_user_slots(), persisted_path_wins_over_missing_workspace(), rom_setup_json() (+16 more)
...
Cohesion: 0.17
Nodes (19): attr_mark_load_matrix_models_and_speeds(), attr_mark_type_load_128k_flash(), attr_mark_type_load_plus3_flash(), ay_frame_audio_nonzero_when_tone_programmed(), boggit_side1_matrix_when_present(), custom_loader_matrix_models_instant_and_ear(), DivMmcError, inspect_128k_paging() (+11 more)
...
Cohesion: 0.26
Nodes (9): MachineConfigEditorView, .body, .hardwareCompat, Binding, Bool, String, UserMachineConfig, HardwareCompatFlags (+1 more)
...
Cohesion: 0.11
Nodes (9): rom_load_wrong_size_is_typed(), RomLoadError, Error, Result, Multiface1, multiface1_port_match(), Option, Path (+1 more)
...
Cohesion: 0.13
Nodes (13): model_rom_path_key(), pref_model_slug_matches_json_snake_case(), PrefModel, BTreeMap, Default, Model, Option, Self (+5 more)
...
Cohesion: 0.14
Nodes (9): emit_contend_sampled(), manual_read_track1_sector1(), MemIo128, MemIo48, MemIoPlus3, timex_scld_ext_colour_render_uses_alt_attrs(), timex_scld_hires_render_interleaves_files(), timex_ts2068_boot_smoke() (+1 more)
...
### Community 209 - ".attach_multiface"
Cohesion: 0.36
...
- **Why does `HostSession` connect `HostSession` to `.share_host`, `.capture_framebuffer`, `AgentClient`, `HostError`, `.patch_prefs`, `joystick.rs`, `ControlPlane`, `.lock_host`, `arkanoid_ram_diff.rs`, `agent_embed.rs`, `ModelId`, `.with_session_ref`, `.regs`, `.recompose_input`, `src/session.rs`, `arkanoid_realtime_gate.rs`, `EmulatorHost`, `arkanoid_paddle_probe.rs`?**
...
- **Why does `HostBridge` connect `HostBridge` to `Model`, `LivingRoomNSView`, `PrefModelSlug`, `AppKit`, `control_plane/src/window_capture.rs`, `MachineConfigEditorView`, `RomSetupSlot`, `LoadKeyScript`, `.body`, `SpectrumNSView`, `.refreshInspector`, `ContentView`, `NSEvent`, `.init`, `TapeAudioPlayer`, `InputLatencyProbe`?**
