...
## Corpus Check
- 167 files · ~216,773 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4118 nodes · 11406 edges · 168 communities (138 shown, 24 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 281 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2a0c7e9a`
...
Cohesion: 0.10
Nodes (7): HostError, HostRegs, peek_poke_and_inspect_json(), Error, Path, Result, String
...
Cohesion: 0.08
Nodes (23): decode_port(), Drive, If1Port, Interface1, Interface1RomError, mdr_roundtrip_via_if1(), motor_select_and_sector_stream_read(), motor_select_and_sector_stream_write() (+15 more)
...
Cohesion: 0.14
Nodes (35): attach_beta_on_48k_and_reject_plus3(), border_toggle_resizes_framebuffer(), cursor_left_via_joystick_applies_caps_five(), dims(), joystick_kempston_mask_reaches_port(), kempston_arrow_left_does_not_pollute_matrix(), kempston_mouse_ports_after_synthetic_deltas(), load_dsk_rejects_non_plus3() (+27 more)
...
Cohesion: 0.13
Nodes (28): parse_sna128_regs_banks_pc(), parse_sna128_when_paged_is_bank5(), parse_z80_rejects_undersized_extended_header(), parse_z80_v1_compressed_regs_and_ram(), parse_z80_v1_uncompressed_regs_and_ram(), parse_z80_v2_128_banks_and_7ffd(), parse_z80_v2_pages_land_at_48k_addresses(), parse_z80_v3_hw8_is_plus2a() (+20 more)
...
Cohesion: 0.12
Nodes (19): continue_and_eject_require_machine(), health_and_inspect_after_rom_load(), last_error_records_failures(), LastErrorRecord, map_host_model_error(), mouse_requires_kempston_pref_then_accepts_input(), prefs_apply_after_rom_load(), prefs_patch_round_trip() (+11 more)
...
### Community 46 - "String"
Cohesion: 0.15
Nodes (10): MemoryMapResponse, MemoryRegion, PagingSnapshot, Option, String, RunResponse, RunUntilResponse, ServerConfig (+2 more)
...
Cohesion: 0.13
Nodes (25): beta_ports_when_trdos_paged_via_bus48(), beta_trdos_rom_overlays_when_paged(), contend_128_differs_from_48_at_paper_start(), divmmc_automap_via_notify_m1(), divmmc_conmem_overlays_via_bus48(), divmmc_control_beats_interface1_on_shared_e3(), divmmc_eeprom_fixture_automaps_when_present(), interface1_microdrive_ports_via_bus48() (+17 more)
...
Cohesion: 0.12
Nodes (7): HeadlessRoom, c_void, Debug, Formatter, Result, Self, String

### Community 55 - "Debugger"
Cohesion: 0.11
Nodes (10): format_break_reason(), BreakReason, Debugger, Cell, Default, Option, Self, Vec (+2 more)
...
Cohesion: 0.22
Nodes (15): decode_z80_page(), decode_z80_v1(), FormatError, load_z80_v2_pages_128(), load_z80_v2_pages_48(), parse_z80_header(), Display, Error (+7 more)
...
### Community 70 - "Bus48"
Cohesion: 0.11
Nodes (4): Bus48, emit_floating_sampled(), multiface_in_9f_pages_back_in(), Option
...
### Community 77 - ".with_machine_load"
Cohesion: 0.28
Nodes (4): apply_prefs_to_session(), FnOnce, R, UserMachineConfig

### Community 78 - ".scheduleSteppedResizeIfNeeded"
Cohesion: 0.20
...
### Community 81 - "mdr.rs"
Cohesion: 0.32
Nodes (3): Result, Self, sector_roundtrip()
...
### Community 120 - ".attach_multiface"
Cohesion: 0.33
Nodes (4): bus128_m1_pages_trdos_at_3d00_not_3c00(), multiface_kempston_on_in_1f_while_attached(), Result, String
...
Cohesion: 0.12
Nodes (11): model_slug(), Self, String, HardwareStatusResponse, HealthResponse, LastBreakResponse, From, Vec (+3 more)
...
- **Why does `HostBridge` connect `HostBridge` to `Model`, `agent_embed.rs`, `LivingRoomNSView`, `PrefModelSlug`, `JoystickMode`, `MachineConfigEditorView`, `RomSetupSlot`, `NSEvent`, `.scheduleSteppedResizeIfNeeded`, `.livingRoomToolbar`, `SpectrumNSView`, `Bool`, `ContentView`, `.body`, `TapeAudioPlayer`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **Why does `HostSession` connect `HostSession` to `app/src/lib.rs`, `host_api/src/ffi.rs`, `agent_embed.rs`, `ModelId`, `AgentClient`, `HostError`, `service.rs`, `joystick.rs`, `.with_machine_load`, `ControlPlane`, `.with_session_ref`, `.run_frame`, `error.rs`, `session.rs`, `EmulatorHost`?**
