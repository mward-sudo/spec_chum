# Graph Report - 373-titles  (2026-09-08)

## Corpus Check
- 200 files · ~239,065 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4446 nodes · 11957 edges · 201 communities (158 shown, 34 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 451 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3d7d8b0`
...
Cohesion: 0.07
Nodes (111): break_reason_code(), clear_last_error(), ffi_bad_model_returns_null(), ffi_create_destroy_and_run(), ffi_debug_dump_json_and_peek_null(), ffi_joystick_mode_rejects_truncated_overflow(), ffi_mouse_delta_and_buttons_smoke(), heap_cstring() (+103 more)
...
Cohesion: 0.03
Nodes (50): Float, JoystickMode, UInt32, HostBridge, .isCustomConfigActive, .joystickMode, .kempstonMouse, .livingRoomMode (+42 more)
...
Cohesion: 0.07
Nodes (43): game_running(), load_deathchase(), plus2a_48basic_instant_still_runs_deathchase(), plus2a_menu_loader_ear_runs_deathchase(), plus2a_menu_loader_instant_runs_deathchase(), rom_plus2a(), Machine, Option (+35 more)
...
Cohesion: 0.14
Nodes (43): apply_sna48_sets_pc_ram_and_border(), attr_mark_code_ok(), attr_mark_ear_load_quotes_code_succeeds_at_speed_10(), attr_mark_experience_load_succeeds(), attr_mark_fixture_flash_loads_code_bytes(), attr_mark_load_matrix_models_and_speeds(), attr_mark_load_path_dumps_trace_on_failure(), attr_mark_load_path_must_succeed() (+35 more)
...
### Community 15 - "tzx.rs"
Cohesion: 0.08
Nodes (42): active_pulse_counters_are_block_relative(), advance_clears_high_ear_on_exact_final_pulse_end(), advance_clears_playing_on_exact_final_pulse_boundary(), append_pure_data(), append_standard_block(), append_turbo_block(), arkanoid_downloads_parses_when_present(), empty_tzx_reports_zero_blocks() (+34 more)
...
Cohesion: 0.06
Nodes (20): TimexDockError, custom_loader_ok(), DivMmcError, InsertDiskError, interface1_opcode_fetch_pages_shadow_rom(), interface1_rom_load_skips_cleanly_when_missing(), Interface1Error, Machine (+12 more)
...
Cohesion: 0.14
Nodes (39): attach_beta_on_48k_and_reject_plus3(), cursor_left_via_joystick_applies_caps_five(), joystick_kempston_mask_reaches_port(), kempston_arrow_left_does_not_pollute_matrix(), load_dsk_rejects_non_plus3(), load_rom_and_run_frame_writes_pixels(), load_rzx_and_dsk_require_machine(), load_snapshot48_switches_from_128k() (+31 more)
...
### Community 25 - ".body"
Cohesion: 0.11
Nodes (19): activateSpecChum(), AppDelegate, Notification.Name, .body, .flatSpectrumChrome, .livingRoomChrome, FocusSpectrumView, .isMenuTracking (+11 more)
...
Cohesion: 0.07
Nodes (31): cpu_step_appears_in_trace(), emit_contend_sampled(), inspect_after_boot_steps(), manual_read_track1_sector1(), mem_port_watch(), MemIo128, MemIo48, MemIoPlus3 (+23 more)
...
Cohesion: 0.07
Nodes (35): MachineConfigEditorView, .body, .hardwareCompat, Binding, Bool, String, UserMachineConfig, HardwareCompatFlags (+27 more)
...
Cohesion: 0.07
Nodes (40): advance_frame_t(), apply_snapshot128_plus3_applies_1ffd(), apply_snapshot128_z80_pages_and_7ffd(), apply_z80_snapshot48_sets_pc_ram_and_border(), attr_mark_type_load_128k_flash(), attr_mark_type_load_plus3_flash(), ay_frame_audio_nonzero_when_tone_programmed(), custom_loader_tap() (+32 more)
...
Cohesion: 0.11
Nodes (22): LastErrorResponse, Option, apply_prefs_to_session(), capture_framebuffer_border_override_restores(), capture_framebuffer_restores_border_when_run_fails(), continue_and_eject_require_machine(), health_and_inspect_after_rom_load(), last_error_records_failures() (+14 more)

### Community 48 - ".recompose_input"
Cohesion: 0.12
Nodes (6): load_128_or_plus3_rom(), rom_search_roots(), BTreeMap, JoystickMode, Self, UserMachineConfig
...
Cohesion: 0.10
Nodes (10): From, WatchSpec, Debugger, Cell, Default, Option, Self, Vec (+2 more)
...
### Community 74 - "String"
Cohesion: 0.12
Nodes (15): format_break_reason(), HealthResponse, LastBreakResponse, MemoryMapResponse, MemoryRegion, PagingSnapshot, PrefsPatch, Option (+7 more)

### Community 75 - ".with_session_ref"
Cohesion: 0.17
Nodes (5): HardwareStatusResponse, FnOnce, R, Vec, WatchesResponse
...
### Community 96 - "crt_phosphor_local"
Cohesion: 0.21
...
Cohesion: 0.25
Nodes (20): load_dsk(), load_rom(), load_rzx(), load_snapshot(), load_trd(), HeaderMap, Json, Response (+12 more)
...
### Community 115 - ".run_frame"
Cohesion: 0.18
Nodes (4): border_toggle_resizes_framebuffer(), dims(), render_frame_pcm(), Vec
...
### Community 120 - "Bus128"
Cohesion: 0.22
Nodes (3): Bus128, out_7ffd_screen_switch_spills_into_next_frame(), page_7ffd()
...
### Community 182 - "ContentView"
Cohesion: 0.11
Nodes (18): ContentView, .livingRoomToolbar, .machineModelMenu, .statusFooter, .statusFooterDeckControls, .statusFooterLeading, .statusFooterMessageIsError, .statusFooterProgress (+10 more)
...
Cohesion: 0.18
Nodes (21): get_prefs(), JoystickBody, KeyAction, KeysBody, MouseBody, patch_prefs(), HeaderMap, Json (+13 more)
...
### Community 192 - "crt_phosphor_local"
Cohesion: 0.67
...
- **Why does `HostSession` connect `HostSession` to `FramebufferMeta`, `host_api/src/ffi.rs`, `.regs`, `AgentClient`, `HostError`, `.init`, `HostViewState`, `.with_session_ref`, `joystick.rs`, `ControlPlane`, `service.rs`, `.recompose_input`, `.run_frame`, `agent_embed.rs`, `src/session.rs`, `ModelId`, `EmulatorHost`?**
...
- **Why does `HostBridge` connect `HostBridge` to `Model`, `.init`, `LivingRoomNSView`, `PrefModelSlug`, `AppKit`, `RomSetupSlot`, `LoadKeyScript`, `.refreshInspector`, `.body`, `SpectrumNSView`, `agent_embed.rs`, `ContentView`, `NSEvent`, `.body`, `.takeMediaTitle`, `TapeAudioPlayer`?**
...
- **Should `host_api/src/ffi.rs` be split into smaller, more focused modules?**
  _Cohesion score 0.07456528146183318 - nodes in this community are weakly interconnected._
