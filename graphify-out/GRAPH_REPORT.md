...
## Corpus Check
- 184 files · ~225,684 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4269 nodes · 11571 edges · 180 communities (148 shown, 26 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 443 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8c259c95`
...
Cohesion: 0.07
Nodes (8): HostError, HostSession, peek_poke_and_inspect_json(), Into, Path, Result, String, BreakReason
...
Cohesion: 0.13
Nodes (38): attach_beta_on_48k_and_reject_plus3(), cursor_left_via_joystick_applies_caps_five(), joystick_kempston_mask_reaches_port(), kempston_arrow_left_does_not_pollute_matrix(), kempston_mouse_ports_after_synthetic_deltas(), load_128_or_plus3_rom(), load_dsk_rejects_non_plus3(), load_rom_and_run_frame_writes_pixels() (+30 more)
...
Cohesion: 0.15
Nodes (4): BTreeMap, JoystickMode, Model, UserMachineConfig
...
- **Why does `HostSession` connect `HostSession` to `host_api/src/ffi.rs`, `AgentClient`, `ControlPlane`, `src/session.rs`, `.patch_prefs`, `.recompose_input`, `.host_mut`, `Option`, `service.rs`, `.select_model`, `.regs`, `ModelId`, `EmulatorHost`, `.capture_framebuffer`, `HostAccess`, `.with_session_ref`, `joystick.rs`, `.debug_step`, `agent_embed.rs`?**
  _High betweenness centrality (0.251) - this node is a cross-community bridge._
- **Why does `Machine` connect `Machine` to `Cpu`, `.step_once`, `Ula48`, `Bus48`, `machine/src/lib.rs`, `.new_48k`, `joystick.rs`, `Kempston`, `custom_loader_matrix_models_instant_and_ear`, `Bus128`, `Debugger`, `.cpu_mut`, `BusPlus3`, `Ay8912`, `KempstonMouse`?**
