...
## Corpus Check
- 197 files · ~608,136 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4347 nodes · 11683 edges · 206 communities (165 shown, 32 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 450 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f4ba398`
...
Cohesion: 0.03
Nodes (50): Float, JoystickMode, UInt32, HostBridge, .experienceLoad, .instantLoad, .isCustomConfigActive, .joystickMode (+42 more)
...
### Community 31 - ".patch_prefs"
Cohesion: 0.14
Nodes (9): prefs_patch_round_trip(), PrefsPatch, Arc, Default, ParkingMutex, Self, SessionPrefs, TraceFormat (+1 more)
...
Cohesion: 0.10
Nodes (42): FormatError, Display, Error, String, decode_z80_page(), decode_z80_v1(), load_z80_v2_pages_128(), load_z80_v2_pages_48() (+34 more)
...
Cohesion: 0.10
Nodes (24): LastErrorResponse, Option, encode_framebuffer_png(), Vec, capture_framebuffer_border_override_restores(), capture_framebuffer_restores_border_when_run_fails(), continue_and_eject_require_machine(), HardwareStatusResponse (+16 more)

### Community 48 - ".load_rom_bytes_with_overrides"
Cohesion: 0.11
Nodes (10): load_128_or_plus3_rom(), render_frame_pcm(), rom_search_roots(), BTreeMap, Model, PathBuf, Self, UserMachineConfig (+2 more)
...
Cohesion: 0.13
Nodes (28): BackgroundColor, Changed, ChildSpawnerCommands, OpenMediaDialog, chrome_button(), chrome_buttons(), ChromeAction, host_cmd_shortcuts() (+20 more)

### Community 53 - "Bus128"
Cohesion: 0.14
Nodes (7): Bus128, emit_floating_sampled(), out_7ffd_records_display_screen_events(), out_7ffd_screen_switch_spills_into_next_frame(), page_7ffd(), Option, Vec
...
Cohesion: 0.09
Nodes (23): EmulatorHost, host_hotkeys(), HostPlugin, model_label(), App, Assets, ButtonInput, Debug (+15 more)
...
Cohesion: 0.18
Nodes (7): FramebufferMeta, model_slug(), parse_model_slug(), ApiResult, Option, Self, String
...
### Community 67 - ".selectBuiltinModel"
Cohesion: 0.10
...
Cohesion: 0.16
Nodes (8): format_break_reason(), HealthResponse, LastBreakResponse, String, RunUntilResponse, ServerConfig, StatusResponse, TypeLoadResponse
...
Cohesion: 0.17
Nodes (12): spec-chum-debugging skill, ./scripts/check.sh, host_api crate, living_room crate, C ABI FFI-only policy, Guest framebuffer PNG export, Bevy 3D CRT living-room host, spec-chum-room (+4 more)
...
Cohesion: 0.29
Nodes (5): FileDialogPlugin, App, Plugin, ResMut, run_open_dialog()
...
### Community 131 - "peek_poke_and_inspect_json"
Cohesion: 0.22
Nodes (3): HostRegs, peek_poke_and_inspect_json(), RegsPatch
...
Cohesion: 0.10
Nodes (28): AtomicUsize, audio_capture_enabled(), AudioMuted, AudioOut, AudioPlugin, AudioStream, DcBlock, fill_output() (+20 more)
...
### Community 180 - "image_copy_driver"
Cohesion: 0.33
Nodes (6): image_copy_driver(), GpuImage, Option, RenderAssets, RenderQueue, RenderContext

### Community 182 - "MachineConfigEditorView"
Cohesion: 0.08
Nodes (32): ContentView, .livingRoomToolbar, .statusFooter, .statusFooterDeckControls, .statusFooterLeading, .statusFooterProgress, .statusFooterTapeName, .tapeLoadModeAccessibilityValue (+24 more)
...
## Knowledge Gaps
- **170 isolated node(s):** `PackageDescription`, `Notification.Name`, `.statusFooterTapeName`, `.tapeLoadModeAccessibilityValue`, `.isMenuTracking` (+165 more)
...
- **Why does `HostSession` connect `HostSession` to `FramebufferMeta`, `host_api/src/ffi.rs`, `peek_poke_and_inspect_json`, `.recompose_input`, `AgentClient`, `HostError`, `EmulatorHost`, `.with_session_ref`, `joystick.rs`, `ControlPlane`, `service.rs`, `.load_rom_bytes_with_overrides`, `src/session.rs`, `.share_host`, `rom_setup.rs`, `handle.rs`, `.with_machine_load`, `.patch_prefs`?**
  _High betweenness centrality (0.252) - this node is a cross-community bridge._
- **Why does `Machine` connect `Machine` to `Cpu`, `.step_once`, `Ula48`, `Bus48`, `machine/src/lib.rs`, `.new_48k`, `joystick.rs`, `Kempston`, `attr_mark_load_matrix_models_and_speeds`, `Bus128`, `Debugger`, `.cpu_mut`, `BusPlus3`, `Ay8912`, `KempstonMouse`?**
  _High betweenness centrality (0.215) - this node is a cross-community bridge._
- **Why does `EmulatorHost` connect `EmulatorHost` to `HostSession`, `ui_overlay.rs`, `file_dialog.rs`?**
