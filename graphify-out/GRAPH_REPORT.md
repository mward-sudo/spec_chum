...
## Corpus Check
- 199 files · ~610,752 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4391 nodes · 11799 edges · 197 communities (156 shown, 32 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 450 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a3d77cf5`
...
Cohesion: 0.03
Nodes (51): .machineModelMenu, Bool, Float, JoystickMode, Model, String, UInt32, URL (+43 more)
...
Cohesion: 0.07
Nodes (8): HostError, HostSession, peek_poke_and_inspect_json(), Error, Into, Path, Result, String
...
### Community 15 - "tzx.rs"
Cohesion: 0.09
Nodes (34): active_pulse_counters_are_block_relative(), advance_clears_high_ear_on_exact_final_pulse_end(), advance_clears_playing_on_exact_final_pulse_boundary(), append_pure_data(), append_standard_block(), append_turbo_block(), arkanoid_downloads_parses_when_present(), empty_tzx_reports_zero_blocks() (+26 more)
...
Cohesion: 0.14
Nodes (41): attach_beta_on_48k_and_reject_plus3(), border_toggle_resizes_framebuffer(), cursor_left_via_joystick_applies_caps_five(), joystick_kempston_mask_reaches_port(), kempston_arrow_left_does_not_pollute_matrix(), kempston_mouse_ports_after_synthetic_deltas(), load_dsk_rejects_non_plus3(), load_rom_and_run_frame_writes_pixels() (+33 more)
...
Cohesion: 0.09
Nodes (19): prefs_restore_model_tape_volume_on_launch(), App, Context, Debug, Frame, Instant, Model, Mutex (+11 more)
...
Cohesion: 0.09
Nodes (33): corrupt_file_falls_back_to_defaults(), custom_configs_round_trip(), default_prefs_path(), load_prefs(), load_prefs_unlocked(), missing_file_falls_back_to_defaults(), model_rom_path_key(), model_rom_paths_round_trip() (+25 more)
...
Cohesion: 0.10
Nodes (25): LastErrorResponse, Option, capture_framebuffer_border_override_restores(), capture_framebuffer_restores_border_when_run_fails(), continue_and_eject_require_machine(), health_and_inspect_after_rom_load(), last_error_records_failures(), LastErrorRecord (+17 more)
...
Cohesion: 0.09
Nodes (11): InputLatencyProbe, Bool, Int, Int32, String, UInt32, Bool, UInt32 (+3 more)
...
Cohesion: 0.16
Nodes (8): encode_framebuffer_png(), FramebufferMeta, parse_model_slug(), ApiResult, Option, Self, Vec, RunResponse
...
Cohesion: 0.15
Nodes (7): DebugInspectorView, .body, Bool, Int32, String, UInt32, UInt8
...
### Community 88 - ".scheduleSteppedResizeIfNeeded"
Cohesion: 0.22
...
### Community 123 - ".with_machine_load"
Cohesion: 0.28
...
Cohesion: 0.14
Nodes (5): HostRegs, RegsPatch, Machine, Option, TypeLoadResult

### Community 172 - "LoadKeyScript"
Cohesion: 0.18
Nodes (7): .statusFooterDeckControls, UInt16, LoadKeyScript, Step, Bool, Int, UInt32
...
- **Why does `HostSession` connect `HostError` to `FramebufferMeta`, `host_api/src/ffi.rs`, `.recompose_input`, `AgentClient`, `HostViewState`, `String`, `HostSession`, `joystick.rs`, `ControlPlane`, `service.rs`, `EmulatorHost`, `ModelId`, `BreakReason`, `agent_embed.rs`, `src/session.rs`, `.share_host`, `.with_machine_load`, `HostAccess`?**
  _High betweenness centrality (0.262) - this node is a cross-community bridge._
- **Why does `Machine` connect `Machine` to `Cpu`, `.step_once`, `Ula48`, `machine/src/lib.rs`, `.new_48k`, `joystick.rs`, `Kempston`, `attr_mark_load_matrix_models_and_speeds`, `Bus48`, `Debugger`, `.cpu_mut`, `BusPlus3`, `Ay8912`, `KempstonMouse`?**
  _High betweenness centrality (0.209) - this node is a cross-community bridge._
- **Why does `EmulatorHost` connect `EmulatorHost` to `tick_emulator`, `ui_overlay.rs`, `OpenMediaDialog`, `HostError`?**
