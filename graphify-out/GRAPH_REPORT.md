...
## Corpus Check
- 167 files · ~215,417 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4107 nodes · 11339 edges · 170 communities (139 shown, 24 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 274 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92ecbd20`
...
Cohesion: 0.17
Nodes (26): apply_trdos_find_boot_native_abi(), apply_trdos_run_native_abi(), debug_trdos_line_new_handoff(), debug_trdos_run_pc_trace(), ensure_trdos_beta128_prog(), enter_128k_basic_from_menu(), enter_trdos_command_mode(), init_trdos_usr_call_frame() (+18 more)
...
Cohesion: 0.08
Nodes (27): advance_frame_t(), emit_contend_sampled(), manual_read_track1_sector1(), mem_port_watch(), MemIo128, MemIo48, MemIoPlus3, multiface_in_pages_out_and_back_for_return() (+19 more)
...
Cohesion: 0.19
Nodes (21): parse_sna128_regs_banks_pc(), parse_sna128_when_paged_is_bank5(), parse_z80_rejects_undersized_extended_header(), parse_z80_v1_compressed_regs_and_ram(), parse_z80_v1_uncompressed_regs_and_ram(), parse_z80_v2_128_banks_and_7ffd(), parse_z80_v2_pages_land_at_48k_addresses(), parse_z80_v3_hw8_is_plus2a() (+13 more)
...
Cohesion: 0.07
Nodes (39): apply_snapshot128_plus3_applies_1ffd(), apply_snapshot128_z80_pages_and_7ffd(), apply_z80_snapshot48_sets_pc_ram_and_border(), attr_mark_type_load_128k_flash(), attr_mark_type_load_plus3_flash(), ay_frame_audio_nonzero_when_tone_programmed(), beta_reads_synthetic_boot_basic_into_ram(), custom_loader_tap() (+31 more)
...
### Community 57 - "interface1_opcode_fetch_pages_shadow_rom"
Cohesion: 0.40
...
Cohesion: 0.23
Nodes (12): attr_mark_load_matrix_models_and_speeds(), beta_trdos_rom_loop_reads_trd_sector_into_ram(), beta_write_track_via_synthetic_rom(), boggit_side1_matrix_when_present(), custom_loader_matrix_models_instant_and_ear(), MachineBuildError, rom_timex_tc2048(), Result (+4 more)
...
Cohesion: 0.08
Nodes (24): assert_z80test_passed(), code_block(), fixture_dir(), rom48_path(), Duration, Path, PathBuf, Result (+16 more)

### Community 128 - "fb_scale.rs"
Cohesion: 0.40
Nodes (4): blit_to_crt(), dims_from_rgba_len(), Option, scale_hires_paper_to_crt()

### Community 129 - ".scheduleSteppedResizeIfNeeded"
Cohesion: 0.20
...
- **Why does `HostBridge` connect `HostBridge` to `Model`, `.scheduleSteppedResizeIfNeeded`, `agent_embed.rs`, `LivingRoomNSView`, `PrefModelSlug`, `JoystickMode`, `MachineConfigEditorView`, `RomSetupSlot`, `NSEvent`, `.livingRoomToolbar`, `SpectrumNSView`, `Bool`, `ContentView`, `.body`, `TapeAudioPlayer`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **Why does `Machine` connect `Machine` to `.add_t`, `Bus128`, `.step_once`, `Ula48`, `Bus48`, `machine/src/lib.rs`, `.new_48k`, `joystick.rs`, `Ay8912`, `custom_loader_matrix_models_instant_and_ear`, `Kempston`, `Debugger`, `.cpu_mut`, `interface1_opcode_fetch_pages_shadow_rom`, `BusPlus3`, `KempstonMouse`?**
  _High betweenness centrality (0.195) - this node is a cross-community bridge._
- **Why does `HostSession` connect `HostSession` to `host_api/src/ffi.rs`, `agent_embed.rs`, `ModelId`, `AgentClient`, `HostError`, `service.rs`, `joystick.rs`, `ControlPlane`, `.with_session_ref`, `.with_host_mut`, `.load_rom_bytes_with_overrides`, `app/src/lib.rs`, `error.rs`, `session.rs`, `EmulatorHost`?**
