...
## Corpus Check
- 167 files · ~213,165 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4095 nodes · 11281 edges · 169 communities (139 shown, 24 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 269 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `da19daae`
...
Cohesion: 0.05
Nodes (32): .livingRoomToolbar, HostBridge, .experienceLoad, .hasBeta, .hasTimexDock, .instantLoad, .isCustomConfigActive, .joystickMode (+24 more)
...
Cohesion: 0.09
Nodes (9): HostError, HostRegs, kempston_mouse_ports_after_synthetic_deltas(), peek_poke_and_inspect_json(), Error, Path, Result, String (+1 more)
...
Cohesion: 0.19
Nodes (36): apply_sna48_sets_pc_ram_and_border(), attr_mark_code_ok(), attr_mark_ear_load_quotes_code_succeeds_at_speed_10(), attr_mark_experience_load_succeeds(), attr_mark_fixture_flash_loads_code_bytes(), attr_mark_load_path_dumps_trace_on_failure(), attr_mark_load_path_must_succeed(), boggit_header_flash_loads_when_present() (+28 more)
...
Cohesion: 0.17
Nodes (7): Model, plus3_loader_dos_boot_runs_titled_marker(), plus3_loader_load_disk_runs_basic_marker(), plus3_loader_talks_to_fdc_on_data_disk(), plus3_model_keeps_disk_interface(), reset_keeps_plus3_disk_inserted(), rom_plus3_only()
...
Cohesion: 0.14
Nodes (33): attach_beta_on_48k_and_reject_plus3(), cursor_left_via_joystick_applies_caps_five(), joystick_kempston_mask_reaches_port(), kempston_arrow_left_does_not_pollute_matrix(), load_128_or_plus3_rom(), load_dsk_rejects_non_plus3(), load_rom_and_run_frame_writes_pixels(), load_rzx_and_dsk_require_machine() (+25 more)

### Community 22 - ".read"
Cohesion: 0.14
Nodes (10): ay_frame_audio_nonzero_when_tone_programmed(), emit_contend_sampled(), manual_read_track1_sector1(), MemIo128, MemIo48, MemIoPlus3, plus2a_stack_repair_ignores_coincidental_0038_marker(), timex_scld_ext_colour_render_uses_alt_attrs() (+2 more)
...
Cohesion: 0.16
Nodes (26): beta_reads_synthetic_boot_basic_into_ram(), beta_trdos_rom_loop_reads_trd_sector_into_ram(), beta_write_track_via_synthetic_rom(), debug_trdos_line_new_handoff(), debug_trdos_run_pc_trace(), ensure_trdos_beta128_prog(), enter_128k_basic_from_menu(), enter_trdos_command_mode() (+18 more)
...
### Community 28 - ".body"
Cohesion: 0.09
Nodes (5): App, SpecChumMacApp, .body, Scene, URL
...
Cohesion: 0.13
Nodes (15): advance_frame_t(), mem_port_watch(), multiface_in_pages_out_and_back_for_return(), peek_opcode(), reg_snap(), Option, TapeDeck, TapeProgress (+7 more)
...
Cohesion: 0.05
Nodes (50): JoystickMode, cursor, .id, kempston, sinclairLeft, sinclairRight, .title, CodingKeys (+42 more)
...
Cohesion: 0.09
Nodes (32): apply_snapshot128_z80_pages_and_7ffd(), apply_z80_snapshot48_sets_pc_ram_and_border(), attr_mark_type_load_128k_flash(), custom_loader_tap(), FrameAudio, inspect_128k_paging(), m1_refresh_pentagon128_skips_snow(), m1_refresh_per_fetch_contention_not_stale() (+24 more)
...
Cohesion: 0.17
Nodes (4): BTreeMap, Model, Self, UserMachineConfig
...
### Community 88 - "Bool"
Cohesion: 0.09
Nodes (10): .body, LoadKeyScript, Step, Bool, Int, UInt16, Int32, IOSurface (+2 more)
...
Cohesion: 0.06
Nodes (12): HostAccess, Deref, DerefMut, MutexGuard, Self, HostSession, Into, JoystickMode (+4 more)
...
- **Why does `HostBridge` connect `HostBridge` to `Model`, `agent_embed.rs`, `LivingRoomNSView`, `PrefModelSlug`, `MachineConfigEditorView`, `RomSetupSlot`, `NSEvent`, `.onLivingRoomDisplayTick`, `SpectrumNSView`, `Bool`, `ContentView`, `.body`, `TapeAudioPlayer`?**
  _High betweenness centrality (0.243) - this node is a cross-community bridge._
- **Why does `Machine` connect `Machine` to `.add_t`, `Bus128`, `.step_once`, `Ula48`, `Bus48`, `machine/src/lib.rs`, `.new_48k`, `joystick.rs`, `Kempston`, `.hold_keys`, `.read`, `Debugger`, `.cpu_mut`, `custom_loader_matrix_models_instant_and_ear`, `BusPlus3`, `KempstonMouse`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `HostSession` connect `HostSession` to `.debug_step`, `host_api/src/ffi.rs`, `agent_embed.rs`, `Vec`, `.load_rom_bytes_with_overrides`, `AgentClient`, `HostError`, `.new`, `joystick.rs`, `.with_session_ref`, `ControlPlane`, `.new`, `error.rs`, `session.rs`, `ModelId`, `EmulatorHost`?**
