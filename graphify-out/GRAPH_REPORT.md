...
## Corpus Check
- 204 files · ~256,393 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4593 nodes · 12431 edges · 209 communities (168 shown, 32 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 453 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `35242541`
...
Cohesion: 0.09
Nodes (20): advance_frame_t(), mem_port_watch(), next_frame_n(), peek_opcode(), reg_snap(), Cell, Default, FnMut (+12 more)
...
Cohesion: 0.13
Nodes (20): FormatError, Display, Error, Formatter, Result, String, decode_z80_page(), decode_z80_v1() (+12 more)
...
Cohesion: 0.09
Nodes (34): apply_snapshot128_z80_pages_and_7ffd(), apply_z80_snapshot48_sets_pc_ram_and_border(), attr_mark_type_load_128k_flash(), ay_frame_audio_nonzero_when_tone_programmed(), custom_loader_tap(), FrameAudio, inspect_128k_paging(), m1_refresh_pentagon128_skips_snow() (+26 more)
...
Cohesion: 0.17
Nodes (19): TimexDockError, apply_snapshot128_plus3_applies_1ffd(), attr_mark_load_matrix_models_and_speeds(), attr_mark_type_load_plus3_flash(), boggit_side1_matrix_when_present(), custom_loader_matrix_models_instant_and_ear(), DivMmcError, MachineBuildError (+11 more)
...
### Community 84 - "aperture_debug_enabled"
Cohesion: 0.83
...
Cohesion: 0.07
Nodes (14): custom_loader_ok(), InsertDiskError, interface1_opcode_fetch_pages_shadow_rom(), interface1_rom_load_skips_cleanly_when_missing(), Interface1Error, Machine, Model, plus3_loader_dos_boot_runs_titled_marker() (+6 more)
...
### Community 191 - ".read"
Cohesion: 0.15
Nodes (9): emit_contend_sampled(), manual_read_track1_sector1(), MemIo128, MemIo48, MemIoPlus3, plus2a_stack_repair_ignores_coincidental_0038_marker(), timex_scld_ext_colour_render_uses_alt_attrs(), timex_scld_hires_render_interleaves_files() (+1 more)
...
### Community 208 - "crt_phosphor_local"
Cohesion: 0.67
...
- **Why does `HostSession` connect `HostSession` to `host_api/src/ffi.rs`, `AgentClient`, `HostError`, `handle.rs`, `ControlPlane`, `arkanoid_ram_diff.rs`, `src/session.rs`, `.with_session_ref`, `ModelId`, `.regs`, `arkanoid_realtime_gate.rs`, `EmulatorHost`, `.new`, `.capture_framebuffer`, `service.rs`, `joystick.rs`, `.recompose_input`, `.set_window_capture`, `arkanoid_paddle_probe.rs`?**
...
- **Why does `Machine` connect `Machine` to `Cpu`, `.read`, `.step_once`, `Ula48`, `custom_loader_matrix_models_instant_and_ear`, `machine/src/lib.rs`, `.new_48k`, `joystick.rs`, `Kempston`, `Bus48`, `Debugger`, `.cpu_mut`, `BusPlus3`, `Ay8912`, `KempstonMouse`, `rzx.rs`?**
