// Embed Windows PE icon for release `spec_chum.exe` (#351 promote / #231).
//
...
fn main() {
    ...
    // Shared Spectrum mark (same as Inno Setup / egui PE resource).
    let icon = concat!(
        env!("CARGO_MANIFEST_DIR"),
        "/../../packaging/windows/spec-chum.ico"
    );
