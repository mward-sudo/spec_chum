...
/* Opt-in ZXInfo online tape titles (hash only). Default off. enabled != 0 enables. */
void sc_set_online_tape_titles(void *handle, int enabled);
int sc_online_tape_titles(void *handle);
