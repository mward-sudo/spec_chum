...
//! Phase B (Pentagon 128 / Scorpion ZS-256) requires user-provided main + TR-DOS
//! ROMs — never fetched. Additional distributable images fetched by
//! `./scripts/fetch_roms.sh` — Timex, `OpenSE`, +3e, Datel, `SpeccyBoot`,
//! regional alternates — are documented in `docs/ROMS.md` (#190); wire
//! `rom_candidates` when those models ship.
//!
