...
| Interface 1 / Microdrive | [#139](https://github.com/mward-sudo/spec_chum/issues/139), [#397](https://github.com/mward-sudo/spec_chum/issues/397) | Fuse MDR layout + checksums; ROM-gated CAT/FORMAT token+motor soaks (skip without `roms/if1.rom`); GAP/SYNC “not present” deepen remains on #397 |
