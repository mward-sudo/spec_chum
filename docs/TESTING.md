...
| Interface 1 / Microdrive | [#139](https://github.com/mward-sudo/spec_chum/issues/139) | Fuse MDR layout + checksums (`MdrImage::formatted`); stream R/W unit tests; ROM-gated CAT still optional |
