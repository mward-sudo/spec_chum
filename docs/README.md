...
**Public marketing site (GitHub Pages):** [www/](www/) — static landing (download / platforms). Deploys when a **`v*` release is cut** (not every `main` push). Setup / custom domain: [www/README.md](www/README.md).
